---
title: "Thoughts on grad school applications"
description: |
...
- Grades in undergrad tests don't necessarily correspond to doing well in graduate school. Much of graduate school is about learning how to learn, with the goal to eventually learning things that no one else knows (i.e. research) and so it is helpful for reviewing faculty to see evidence that points to your ability to do that. One way to do this is to create projects that show off what you can do publicly and link to them. Ideally your undergrad professors will integrate projects into their curriculum, but if not then you need to DIY. (BTW don't use Kaggle – hunt, gather, or farm your own data). 
...
- The strongest letters are from folks who know you well and can credibly say you're in the top 5 per cent of something. Usually, this type of letter looks better than someone who doesn't know you well, even if they're a famous professor, and even if you got an A in their class.
