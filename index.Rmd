...
*17 November 2020: If you would like to participate in the Toronto Data Workshop on Reproducibility (25/26 February 2021) then please see [here](https://rohanalexander.com/reproducibility).*
...
The [Toronto Data Lab](https://rohanalexander.com/lab.html) exists to bring this all together and provide opportunities for the training of graduate students.

I enjoy [teaching](https://rohanalexander.com/teaching.html) and aim to help students from a wide range of backgrounds learn how to tell stories with data. The notes that support my teaching are available here: https://www.tellingstorieswithdata.com/. In Fall 2020 I am teaching ['Surveys, Sampling and Observational Data'](https://rohanalexander.com/sta304.html) in Statistical Sciences; and in Winter 2021 I am teaching ['Experimental Design'](https://rohanalexander.com/inf2178.html) in Information and will also be leading a reading course ['Ethics and Data Science'](https://rohanalexander.com/reading_course-ethics.html). I am an [RStudio Certified Tidyverse Trainer](https://education.rstudio.com/trainers).
