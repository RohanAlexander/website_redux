...
| SQL Quiz 						| 2 		 | Friday, noon, Week 11 |
...
- Task: [Donaldson Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-paper-one)
...
- Task: [Mawson Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-paper-two)
...
- Task: [Howrah Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-paper-three)
- Weight: 25 per cent (for Papers #1-#4 the best two of four counts).

### Paper #4

- Due date: Friday, noon, Week 10 (with grace period through to Sunday, midnight, to submit without penalty).
- Task: [Dysart Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-paper-four) or [Spofforth Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-paper-five)
- Weight: 25 per cent (for Papers #1-#4 the best two of four counts).

### Final Paper

- Task: [Final Paper](https://tellingstorieswithdata.com/24-assessment.html#sec-final-paper)
- You must submit this paper.
- Due dates: 
