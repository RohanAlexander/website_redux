...
- [Several end-to-end worked examples](https://tellingstorieswithdata.com/02-drinking_from_a_fire_hose.html): Canadian elections; Toronto homelessness; and neonatal mortality.

### Week 2

- [R Essentials](https://tellingstorieswithdata.com/03-r_essentials.html): R, R Studio, and R Studio Cloud; the `dplyr` verbs; base; `ggplot2`; and `tidyverse`.
  
### Week 3

- [Reproducible workflow](https://tellingstorieswithdata.com/04-workflow.html): Reproducibility; Quarto; R projects and file structure; Git and GitHub; and R in practice.
- [Writing research](https://tellingstorieswithdata.com/05-on_writing.html): Developing research questions; and writing.

### Week 4

- [Static communication](https://tellingstorieswithdata.com/06-static_communication.html): Graphs; tables; and maps.

  
### Week 5

- [Interactive communication](https://tellingstorieswithdata.com/07-interactive_communication.html): Websites; interactive maps; and `Shiny`.


### Week 6

- [Farm data](https://tellingstorieswithdata.com/08-farm.html): Censuses and sampling.

### Week 7

- [Gather data](https://tellingstorieswithdata.com/09-gather.html): Sampling essentials; APIs; web scraping; and PDFs.

### Week 8

- [Hunt data](https://tellingstorieswithdata.com/10-hunt.html): Experiments and randomized controlled trials; A/B testing; and implementing surveys.

### Week 9

- [Clean and prepare data](https://tellingstorieswithdata.com/11-clean_and_prepare.html): Workflow; case study; checks and tests; and names.

### Week 10

- [Store and share data](https://tellingstorieswithdata.com/12-store_and_share.html): GitHub; R packages; depositing data; documentation; and personally identifying information.

### Week 11

- [Exploratory data analysis](https://tellingstorieswithdata.com/13-eda.html): Exploring individual variables; relationships between variables; and multiple relationships.


### Week 12

- [It’s Just A Linear Model](https://tellingstorieswithdata.com/14-ijalm.html)
