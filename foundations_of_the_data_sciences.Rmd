...
- Why is there so much assessment? The only way to learn is to actually do the work, and students only do the work when they are assessed. It is unfortunate, but there is no way around it.
...
Before class starts you should go through Chapters 1, 2, and 3 of *Telling Stories with Data*.
...
- [Writing research](https://tellingstorieswithdata.com/05-writing_research.html)
...
- [Clean and prepare](https://tellingstorieswithdata.com/11-clean_and_prepare.html)
...
- [Store and share](https://tellingstorieswithdata.com/12-store_and_share.html)
...
- [Exploratory data analysis](https://tellingstorieswithdata.com/13-eda.html)
...
- [Generalized linear models](https://tellingstorieswithdata.com/14-ijalm.html)
...
| SQL Quiz 						| 2 		 | Friday, noon, Week 12 |
...
**You must submit Paper 1. You must submit the Final Paper. You must submit and get at least 70 per cent on the SQL Quiz.**
...
- Due date: Available from Week 1, but due Friday, noon, Week 12 (with grace period through to Sunday, midnight, to submit without penalty).
- Weight: 2 per cent. You cannot pass the course if you do not get at least 70 per cent in this quiz
