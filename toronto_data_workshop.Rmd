---
title: "Univeristy of Toronto Data Workshop"
description: |
  We share best practice in the data munging/cleaning/prep/comms stages that are essential for any data science project, but that folks typically don't talk about. We meet for an hour each week and are interested in anything that is data-focused across academia and industry. Fridays at noon (Toronto time) via Zoom, with most talks recorded and shared. All welcome. Free. Sign up [here](https://forms.gle/sXbEixoa1iJR4Q7A8).
output:
...
The University of Toronto Data Workshop (TDW) brings together academia and industry to consider, collate, share, and disseminate best practices in the data-centric steps of a data science project: collection; cleaning; storage; retrieval; dissemination; protection; communication. We meet weekly for an hour and aim to have a roughly even split of participants from academia and industry over the course of each term. For an invitation please sign up [here](https://forms.gle/sXbEixoa1iJR4Q7A8). Anyone is welcome to attend - you don't need to be affiliated with the university. 
...
| --------- | --------------- | ------------- | ----- |
| Fri 21 May 2021, noon-1pm | David Shor, *OpenLabs* | TBD | |
| Fri 28 May 2021, noon-1pm | Samantha Pierre, *University of Toronto* | Broadway data | |
| Fri 4 June 2021, noon-1pm | Heather Krause, *We All Count* | Equity in Data | |
| Fri 11 June 2021, noon-1pm | Laura Bronner, *FiveThirtyEight* | TBD | |
| Fri 18 June 2021, noon-1pm | Jacob Matson, *Transforming Age* | Data to Dashboard | |
| Fri 25 June 2021, noon-1pm | Nick Huntington-Klein, *Seattle University* | Data cleaning, replication, and researcher decisions | |
| Fri 2 July 2021, noon-1pm | Zachary McCaw, *Google* | TBD | |
| Fri 9 July 2021, noon-1pm | Laura Derksen, *University of Toronto Mississauga*  (jointly hosted with the UTM Collaborative Digital Research Space.) | TBD |  |
| Fri 16 July 2021, noon-1pm | Leslie Root, *University of Colorado Boulder* | TBD | |
| Fri 23 July 2021, noon-1pm | Maria Kamenetsky, *University of Wisconsin-Madison* | TBD | |
| Fri 30 July 2021, noon-1pm | Vincent Arel-Bundock, *Université de Montréal* | The 'modelsummary' R package. | |
| Fri 6 August 2021, 12:30-1:30pm | Ijeamaka Anyene, *Kaiser Permanente Division of Research*  |  |  |
| Fri 13 August 2021, noon-1pm | Silvia Canelón, *University of Pennsylvania* | Lessons Learned from EHR Data | |
| Fri 20 August 2021, 9am-1pm | Undergraduate research day | | |
| Fri 27 August 2021, noon-1pm | Jingchen (Monika) Hu, *Vassar College*, Lisa Lendway, *Macalester College*, Vincenzo Coia, *University of British Columbia, Vancouver* | Panel on teaching data-focused topics. | |



* Friday, 21 May 2021, Noon - 1pm  
	**David Shor**, OpenLabs, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/davidshor)    
...
* Friday, 28 May 2021, Noon - 1pm  
	**Samantha Pierre**, University of Toronto, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/whambamgam)    
...
* Friday, 11 June 2021, Noon - 1pm  
	**Laura Bronner**, FiveThirtyEight, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/laurabronner)    
	Bio: [Laura](www.laurabronner.com) is the quantitative editor at FiveThirtyEight. More generally, I’m a data scientist with an interest in causal inference, political science and quantitative text analysis. Before FiveThirtyEight, I was a Senior Analyst at the Analyst Institute, designing and analyzing field experiments for the 2018 election cycle. In September 2018, I completed a PhD in Political Science at the London School of Economics' Department of Government.    
	Topic: TBA.  
	Recording: TBA.  
* Friday, 18 June 2021, Noon - 1pm  
	**Jacob Matson**, Transforming Age, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/matsonj)    
	Bio: [Jacob](dataduel.co) is the Director of Digital Transformation at Transforming Age, leading the charge of bringing a modern technology stack into the non-profit space. He spends time doing SMB analytics consulting via his agency, Elliot Point LLC.  
	Topic: Data ask to Dashboard.  
	Recording: TBA.  
* Friday, 25 June 2021, Noon - 1pm  
	**Nick Huntington-Klein**, Seattle University, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/nickchk)    
	Bio: [Nick](https://nickchk.com) is an economics professor at Seattle University.  
	Topic: Data cleaning, replication, and researcher decisions.  
	Recording: TBA.  
* Friday, 2 July 2021, Noon - 1pm  
	**Zachary McCaw**, Google  
	...
	Topic: TBD.  
	Recording: TBA.  
* Friday, 9 July 2021, Noon - 1pm  
	**Laura Derksen**, University of Toronto Mississauga, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/lauraderksen)    
	Bio: [Laura](https://sites.google.com/site/lauraderksen) is a global health/development economist in the Management Dept at UTM.  
	Topic: TBD.  
	Recording: TBA.  
* Friday, 16 July 2021, Noon - 1pm  
	**Leslie Root**, University of Colorado Boulder, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/les_ja)    
	Bio: [Leslie](https://leslieroot.net/about/) is a postdoctoral scholar in the Institute of Behavioral Science at CU Boulder, where she works on the RIPL (Reproduction in People's Lives) project. She holds a PhD in Demography from UC Berkeley.  
	Topic: TBD.  
	Recording: TBA.  
* Friday, 23 July 2021, Noon - 1pm  
	**Maria Kamenetsky**, University of Wisconsin-Madison, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/mkamenets)  
	Bio: [Maria](https://mariakamenetsky.com/) is a PhD candidate in Epidemiology at the University of Wisconsin-Madison, where she also received her MS in Statistics. Her research focuses on methods in spatial epidemiology, specifically working on statistical methods for spatial cluster detection and applications to disease surveillance.	  
	Topic: TBD.  
	Recording: TBA.  
* Friday, 30 July 2021, Noon - 1pm  
	**Vincent Arel-Bundock**, Université de Montréal, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/VincentAB)  
	Bio: [Vincent](http://arelbundock.com) is a political scientist at the Université de Montréal, where I read on comparative and international political economy. I am particularly interested in the politics of international taxation and foreign direct investment, but I have also worked on economic voting, monetary policy, foreign aid, and research methods. My articles have appeared in peer-reviewed journals such as International Organization, the Journal of Politics, the British Journal of Political Science, International Studies Quarterly and Political Analysis.  
	Topic: The 'modelsummary' R package.  
	Recording: TBA.  
* Friday, 6 August 2021, 12:30pm - 1pm  
	**Ijeamaka Anyene**, Kaiser Permanente Division of Research, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/ijeamaka_a)  
	Bio: [Ijeamaka](https://ijeamaka-anyene.netlify.app) is a data analyst working in healthcare research. I specialize in using R and SAS for data analysis, epidemiological research, and data visualizations. I am also passionate about computational art, knowledge sharing / dissemination, and how to mix the two.    
	Topic: Taking the next step past standard charts.  
	Recording: TBA.  
* Friday, 13 August 2021, Noon - 1pm  
	**Silvia Canelón**, University of Pennsylvania, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/spcanelon)  
	Bio: [Silvia](https://silvia.rbind.io) is a postdoctoral research scientist in the Department of Biostatistics, Epidemiology, and Informatics at the University of Pennsylvania where she applies biomedical informatics to population health research. She uses R to work on projects that develop novel data mining methods to extract pregnancy-related information from Electronic Health Records (EHR) and study the relationship between environment and disease. She is also certified as an RStudio Tidyverse Instructor and is passionate about R education as a way to build power in communities.   
	Topic: Lessons Learned from EHR Data.  
	Recording: TBA.  
* Friday, 20 August 2021, 9am - 1pm  
  Undergraduate research panel.
* Friday 27 August 2021, noon - 1pm  
  **Lisa Lendway**, Macalester College,  [`r fa("twitter", fill = "steelblue")`](https://twitter.com/lisalendway)  
  **Vincenzo Coia**, University of British Columbia, Vancouver, [`r fa("twitter", fill = "steelblue")`](https://twitter.com/VincenzoCoia)  
  **Jingchen (Monika) Hu**, Vassar College,  [`r fa("twitter", fill = "steelblue")`](https://twitter.com/monika76five)   
  Bios: [Lisa](https://lisalendway.netlify.app) is a professor of statistics and data science at Macalester College and an R Studio certified instructor of tidyverse. I have used R since 2003 (whoa!) in many different roles: student, statistician/data scientist, and teacher.   
  [Vincenzo](https://vincenzocoia.com/) is an Assistant Professor of Teaching at the University of British Columbia, Vancouver. He holds a PhD in Statistics from UBC, and his priority is to develop data science initiatives through the Department of Statistics.   
  [Jingchen (Monika)](https://pages.vassar.edu/jihu/) is a statistician and an Assistant Professor in the Department of Mathematics and Statistics at Vassar College. I received my Ph.D. in statistics from Duke University Department of Statistical Science in 2015.   
	Topic: Panel on teaching data-focused topics.   
	Recording: TBA.  
