...
To submit, before the polls close, please submit a link to a GitHub repository that contains your data, model, and a brief write up of your approach. For ease of comparision, please also include the following CSV with your riding-specific forecasts: https://rohanalexander.com/images/forecast_summary.csv.

The three invited groups will be:

1. The student team with the most greatest of seats correctly forecast.
