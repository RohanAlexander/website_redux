...
'Drinking from a fire hose' and 'R essentials'

- Content:
  - Several end-to-end worked examples, and review of R.

### Week 2

'R essentials' and 'Workflow'.
...
'Such a shame they'll never meet' and 'why does it always rain on me?'.
