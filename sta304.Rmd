...
- Recording: https://youtu.be/-GfUTkPmuZk
...
- Content: 
  - Sampling, using APIs, scraping, OCR, semi-structured datasets, and text.
- Recording: https://youtu.be/PUIl5znqtbI
...
- Recording: https://youtu.be/d0Kg6vK6Pq4
...
- Recording: https://youtu.be/1C0GxmPaBYM
...
- Recording: https://youtu.be/NCvof6HVLpg
...
- Recording: https://youtu.be/0IsghECP8MI
...
- Content: 
  - MRP
- Recording: https://youtu.be/T0Uy15p0c8I
...
- Content: 
  - Overview
- Recording: https://youtu.be/IvPfkLUfiow
