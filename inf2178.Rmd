...
- Lecture: [Hello world!](https://www.tellingstorieswithdata.com/hello-world.html), [R Essentials](https://www.tellingstorieswithdata.com/r-essentials.html), [Graphs](https://www.tellingstorieswithdata.com/graphs-tables-and-writing.html#graphs).
...
- Lecture: [Workflow](https://www.tellingstorieswithdata.com/workflow.html), [tables and writing](https://www.tellingstorieswithdata.com/graphs-tables-and-writing.html).
...
- Task: ['Mandatory minimums'](https://www.tellingstorieswithdata.com/assessment.html)
...
- Task: ['These numbers mean dial it up'](https://www.tellingstorieswithdata.com/assessment.html)
...
- Weight: 25 per cent (for Papers #1-#3 the best two of three counts).
- Task: ['The Short List'](https://www.tellingstorieswithdata.com/assessment.html)
...
- Task: ['Two Cathedrals'](https://www.tellingstorieswithdata.com/assessment.html)
