...
- Lecture (https://youtu.be/J6EA82-vCB8): Questions and worked example.
...
- Lecture (https://youtu.be/5lEFoU8pPNc): GitHub, `opendatatoronto`, BibTeX, graphing example in small groups, and discussion of 'The Kitchen Counter Observatory' and Tuskegee.
- Lab: Review `ggplot`.
...
- Lecture (*Recording link TBA*): Updated based on student interest/needs, and discussion of 'Experiments on Trial' and Oregon Health Insurance Experiment.
- Lab: 
...
- Content: [Gathering data](https://www.tellingstorieswithdata.com/gathering-data.html).
