...
- Content: [Hello world!](https://www.tellingstorieswithdata.com/hello-world.html), [R Essentials](https://www.tellingstorieswithdata.com/r-essentials.html).
...
- Lecture recording: https://youtu.be/J6EA82-vCB8.
...
- Content: [Workflow](https://www.tellingstorieswithdata.com/workflow.html), [Graphs, tables and writing](https://www.tellingstorieswithdata.com/graphs-tables-and-writing.html).
- Case Study: [Tuskegee Syphilis Study](https://www.tellingstorieswithdata.com/randomised-controlled-trials.html#case-study---tuskegee-syphilis-study).
- Lecture recording: *TBA*. 
- Lab: Go through DoSS Toolkit 'Yellow' and discuss any issues with the TA.
...
- Content: [Scraping](https://www.tellingstorieswithdata.com/03-02-scraping.html), surveys, open data, etc.
...
- Content: Simulation, power, RCTs and A/B testing.
...
- Content: Diff in diff and regression discontinuity.
...
- Content: Instrumental variables.
...
- Weight: 10 per cent (no quiz in Week 1 or Week 10 and only best eight out of ten count.)
...
- Task: ['These numbers mean dial it up'](https://www.tellingstorieswithdata.com/assessment.html#these-numbers-mean-dial-it-up)
...
- Weight: 25 per cent (for Papers #1-#3 the best two of three counts).
- Task: ['The Short List'](https://www.tellingstorieswithdata.com/assessment.html#the-short-list).
...
- Task: ['Two Cathedrals'](https://www.tellingstorieswithdata.com/assessment.html#two-cathedrals)
