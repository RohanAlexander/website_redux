...
- Lecture: [Writing](https://www.tellingstorieswithdata.com/02-02-writing.html), [Workflow](https://www.tellingstorieswithdata.com/01-06-workflow.html), [Reproducibility](https://www.tellingstorieswithdata.com/01-05-reproducibility.html).
...
- Lecture: [Scraping](https://www.tellingstorieswithdata.com/03-02-scraping.html), [surveys](https://www.tellingstorieswithdata.com/03-07-surveys.html), open data, etc.
...
- Lecture: Simulation, power, [RCTs](https://www.tellingstorieswithdata.com/03-05-rcts.html) and [A/B testing](https://www.tellingstorieswithdata.com/03-06-abtesting.html).
...
- Lecture: DAGs, confounding, selection bias, and measurement bias. Factorial designs, Latin Squares, blocking, and the other classics.
...
- Lecture: [Diff in diff](https://www.tellingstorieswithdata.com/06-03-matching_and_differences.html) and [regression discontinuity](https://www.tellingstorieswithdata.com/06-05-rdd).
...
- Lecture: [Instrumental variables](https://www.tellingstorieswithdata.com/06-04-iv).
...
- Lecture: [Shiny](https://www.tellingstorieswithdata.com/02-05-shiny.html), cloud, and deploying into production.
...
- Lecture: [Text-as-data](https://www.tellingstorieswithdata.com/03-04-text.html).
...
- Create a folder with appropriate sub-folders, add it to GitHub, and then prepare a PDF using `R Markdown` with these sections: title, author, date, abstract, data, and references. If you'd like, you are welcome to use this starter folder **TBA**. 
...
- Via Quercus, submit your PDF report. You must provide a link to the GitHub repo where the code that you used for this assignment lives (Hint: Comment. Your. Code.). Your entire workflow must be entirely reproducible. Your repo should be clearly organised and a useful README included.
