...
<!-- I am open to supervising PhD students, but can only help once you are admitted. Admission decisions are made at a department/faculty level and there is little I can do to help you until you're in. If you are already admitted, then please email me. There is no point contacting me until you're admitted. -->

<!-- If you are not yet a Toronto PhD student:  -->

<!-- - Thank you for reaching out! I do understand that grad school applications are stressful and there is a lot of conflicting advice. -->
<!-- - The first step is to apply and be admitted into the PhD program. In my case that likely means either [Information](https://ischool.utoronto.ca/future-students/apply/phd-apply/) or [Statistical Sciences](https://www.statistics.utoronto.ca/graduate/phd-application-information).  -->
...
<!-- I can only provide reference letters to students that work with me. This is because I only write reference letters that very strongly recommend you and I can only confidently strongly recommend you if I've worked with you. -->
